                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="about-content">
                                    ...
                                    <h2>리더스 힐링 아카데미 원우분들을 위한 특전</h2>
                                    <p className='bold'>완벽한 유지관리로 더 나은 미래를 준비할 수 있도록 리더스 힐링 아카데미 원우분들께는 여러 가지 특전이 제공됩니다.<br />
                                    이 특전은 참여한 모든 분들에게 주어지며, 참여를 통해 얻은 노력과 열정에 보답하고자 마련되었습니다.<br />
                                    리더스 힐링 아카데미에서 참여한 모든 원우 분들께, 우수한 건강관리와 예방의 중요성을 인식하고 실천하실 수 있는 기회를 제공합니다. 이를 위해, 중앙대학교 광명병원의 여러 건강검진 프로그램에서 50%의 특별 할인 혜택을 제공하고 있습니다.<br />
...
리더스 힐링 아카데미에서의 참여를 통해 건강한 리더십과 힐링 능력을 함양하시는 분들께, 중앙대학교 광명병원의 건강검진 프로그램을 특별 할인 혜택과 함께 제공함으로써, 더욱 건강하고 행복한 삶을 이루어 가실 수 있기를 기원합니다.</p>
